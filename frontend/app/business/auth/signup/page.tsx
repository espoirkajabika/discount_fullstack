...
// Icons
import {
  EyeOff, Eye, Lock, Store, User, Mail, Phone, MapPin, Globe,
  ArrowLeft, ArrowRight, TrendingUp, Users, BarChart3, Zap, Target, CheckCircle
} from 'lucide-react'
...
export default function BusinessSignup() {
    ...
    const loadCategories = async () => {
      try {
        const response = await fetch(
          `${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8001/api/v1'}/categories/`
        )
        if (response.ok) {
  ...
  // Handle address/location selection - simplified for now
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const result = await registerBusiness(cleanedData)
        ...
        <div className="w-full flex flex-col justify-center items-center p-12 text-white relative z-10">
          ...
          <div className="text-center max-w-lg mb-8">
            ...
            <p className="text-xl text-blue-100 mb-8 leading-relaxed">
              Join thousands of businesses using location-based marketing to grow their customer base and increase foot traffic.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-6 w-full max-w-sm">
            <div className="text-center p-4 bg-white bg-opacity-10 rounded-lg backdrop-blur-sm">
              <div className="text-2xl font-bold text-[#e94e1b] mb-1">2 min</div>
              <div className="text-sm text-blue-600">Average setup time</div>
            </div>
            <div className="text-center p-4 bg-white bg-opacity-10 rounded-lg backdrop-blur-sm">
              <div className="text-2xl font-bold text-[#e94e1b] mb-1">3x</div>
              <div className="text-sm text-blue-600">Increase in foot traffic</div>
            </div>
            <div className="text-center p-4 bg-white bg-opacity-10 rounded-lg backdrop-blur-sm">
      ...
      <div className="w-full lg:w-3/5 flex items-center justify-center p-4 lg:p-8">
        <div className="w-full max-w-2xl">
          ...
          <div className="lg:hidden text-center mb-6">
            <Link href="/" className="inline-flex items-center space-x-2 mb-4 text-white hover:text-[#e94e1b] transition-colors">
          ...
          <Card className="bg-white shadow-2xl border-0 rounded-2xl overflow-hidden">
            <CardHeader className="text-center pb-4">
              ...
              <CardTitle className="lg:hidden text-2xl font-bold text-gray-900">Join PopupReach</CardTitle>
              ...
              <div className="w-full max-w-lg mx-auto mt-6">
                ...
                <div className="flex justify-between text-xs text-gray-500 mt-2">
                  <span className={activeTab === 'account' ? 'text-[#e94e1b] font-medium' : ''}>
                    Account
                  </span>
                  <span className={activeTab === 'business' ? 'text-[#e94e1b] font-medium' : ''}>
                    Business
                  </span>
                  <span className={activeTab === 'details' ? 'text-[#e94e1b] font-medium' : ''}>
                    Details
                  </span>
                </div>
              </div>
            ...
            <CardContent className="px-6 pb-6">
              ...
              <Tabs defaultValue="account" value={activeTab} onValueChange={setActiveTab} className="w-full">
                ...
                <TabsContent value="business" className="space-y-4 mt-6">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="business_description" className="text-gray-700 font-medium">
                  ...
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div className="space-y-2">
                      <Label htmlFor="business_phone" className="text-gray-700 font-medium">
                        Business Phone
                      </Label>
                      <div className="relative">
                        <Phone className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 w-5 h-5" />
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="business_website" className="text-gray-700 font-medium">
                        Website
                      </Label>
                      <div className="relative">
                ...
                <TabsContent value="details" className="space-y-4 mt-6">
                  <div className="space-y-2">
                    <Label htmlFor="business_address" className="text-gray-700 font-medium">
                      Business Address
                    </Label>
                    <div className="relative">
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <h4 className="text-sm font-semibold text-blue-900">You're almost done!</h4>
                        <p className="text-sm text-blue-700 mt-1">
                          Complete your profile to start creating promotions and reaching customers.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                <p className="text-sm text-gray-600 text-center">
                  ...
                  <Link href="/terms" className="text-[#e94e1b] hover:text-[#d13f16] font-medium">
                    Terms of Service
                  </Link>{' '}
                  and{' '}
                  <Link href="/privacy" className="text-[#e94e1b] hover:text-[#d13f16] font-medium">
                    Privacy Policy
                  </Link>
                </p>
              </div>
          ...
          <div className="lg:hidden mt-6 text-center">
            <p className="text-blue-200 text-sm mb-4">Join thousands of successful businesses</p>
            <div className="grid grid-cols-2 gap-4 text-xs text-blue-100">
              <div className="bg-white bg-opacity-10 rounded-lg p-3 backdrop-blur-sm">
                <div className="text-lg font-bold text-[#e94e1b] mb-1">2 min</div>
                <div>Setup time</div>
              </div>
              <div className="bg-white bg-opacity-10 rounded-lg p-3 backdrop-blur-sm">
